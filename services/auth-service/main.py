...
# uvicorn services.auth-service.main:app --reload --port 8001
# Remember to set up your DATABASE_URL environment variable.
# Example: DATABASE_URL="postgresql://youruser:yourpassword@localhost:5432/auth_db"
# And generate a SECRET_KEY
# Example: openssl rand -hex 32
# Store these in a .env file in the services/auth-service directory.
